<template>
  <el-card class="box-card">
    ...
    <el-table v-loading="isTableLoading" :data="formData">
      <el-table-column type="expand">
        <template slot-scope="props">
          ...
          <el-table :data="props.row.answer">
            <el-table-column prop="message" label="回复内容" :show-overflow-tooltip="true"></el-table-column>
            <el-table-column prop="answer_time" label="回复时间"></el-table-column>
      ...
      <el-table-column prop="message" label="提问内容" :show-overflow-tooltip="true"></el-table-column>
      <el-table-column prop="question_time" label="提问时间"></el-table-column>
      <el-table-column label="操作" align="center">
        <template slot-scope="scope">
          <el-button type="primary" @click="reply(scope.row.question_id)">回复</el-button>
          <delete-button
...
<script>
  import {getQuestionApi, deleteQuestionApi, deleteAnswerApi} from '@/api/question'
