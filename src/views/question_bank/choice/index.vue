  ...
  <div id="choice">
    <el-card class="box-card" v-show="isShow">
      <div slot="header" class="clearfix">
        ...
        <el-button type="success" @click="getChoice" class="ml-5">搜索</el-button>
    ...
    <choice-form ref="ChoiceForm" @update="getChoice" @tab="tab" v-show="!isShow" :options="options"></choice-form>
  </div>
</template>
